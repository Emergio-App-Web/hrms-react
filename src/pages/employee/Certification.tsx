...
const Certification = () => {
  return (
    <div>
      <Card  className="relative w-full max-w-3xl mx-auto rounded-3xl bg-[#fbfff2] before:absolute before:content-['My_Certification_/_Achievements'] before:text-[#4F4F4F] before:font-semibold before:text-2xl  before:-top-14">
        <CardContent className="p-5">
          <form action="" className="flex flex-col gap-3 ">

                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr] gap-4 items-center "> 
                    <label htmlFor="" className="text-[14px] font-montserrat font-bold">Document Category</label>
                    <input type="text" name="" id="" className="bg-[#F0F0F0] p-2 rounded-xl" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr] gap-4 items-center"> 
                    <label htmlFor="" className="text-[14px] font-montserrat font-bold">Document</label>
                    <input type="text" name="" id="" className="bg-[#F0F0F0] p-2 rounded-xl" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr] gap-4 items-center"> 
                    <label htmlFor="" className="text-[14px] font-montserrat font-bold">Description</label>
