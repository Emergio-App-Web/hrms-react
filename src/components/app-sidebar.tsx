  ...
  return (
    <>
      ...
      {isMobile && isCollapsed && (
        <button
          className="fixed left-5 top-3 z-50 h-12 w-12 rounded-full bg-black text-white flex items-center justify-center shadow-lg"
      ...
      <aside
        ...
        className={cn(
          ...
          isMobile && [
            "fixed -left-4 top-0 bottom-0 z-40 custom-scrollbar",
